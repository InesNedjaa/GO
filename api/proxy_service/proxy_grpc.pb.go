...
const (
	ProxyService_Metadata_FullMethodName              = "/ProxyService/Metadata"
...
type ProxyServiceClient interface {
	Metadata(ctx context.Context, in *MetadataRequest, opts ...grpc.CallOption) (*Response, error)
...
func (c *proxyServiceClient) Metadata(ctx context.Context, in *MetadataRequest, opts ...grpc.CallOption) (*Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Response)
	err := c.cc.Invoke(ctx, ProxyService_Metadata_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProxyServiceServer interface {
	Metadata(context.Context, *MetadataRequest) (*Response, error)
...
func (UnimplementedProxyServiceServer) Metadata(context.Context, *MetadataRequest) (*Response, error) {
...
func _ProxyService_Metadata_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MetadataRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProxyServiceServer).Metadata(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProxyService_Metadata_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProxyServiceServer).Metadata(ctx, req.(*MetadataRequest))
	}
...
var ProxyService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Metadata",
			Handler:    _ProxyService_Metadata_Handler,
		},
		{
