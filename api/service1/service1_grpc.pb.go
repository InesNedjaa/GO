...
const (
	Service1_GetMetrics_FullMethodName = "/Service1/GetMetrics"
	Service1_GetLogs_FullMethodName    = "/Service1/GetLogs"
)
...
func (c *service1Client) GetMetrics(ctx context.Context, in *MetricsRequest, opts ...grpc.CallOption) (*MetricsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MetricsResponse)
	err := c.cc.Invoke(ctx, Service1_GetMetrics_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *service1Client) GetLogs(ctx context.Context, in *LogsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[LogResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Service1_ServiceDesc.Streams[0], Service1_GetLogs_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type Service1_GetLogsClient = grpc.ServerStreamingClient[LogResponse]
...
func (UnimplementedService1Server) GetMetrics(context.Context, *MetricsRequest) (*MetricsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMetrics not implemented")
}
func (UnimplementedService1Server) GetLogs(*LogsRequest, grpc.ServerStreamingServer[LogResponse]) error {
...
func _Service1_GetMetrics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MetricsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(Service1Server).GetMetrics(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Service1_GetMetrics_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(Service1Server).GetMetrics(ctx, req.(*MetricsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Service1_GetLogs_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(LogsRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(Service1Server).GetLogs(m, &grpc.GenericServerStream[LogsRequest, LogResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Service1_GetLogsServer = grpc.ServerStreamingServer[LogResponse]
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Service1_GetMetrics_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "GetLogs",
			Handler:       _Service1_GetLogs_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "api/service1/service1.proto",
}
